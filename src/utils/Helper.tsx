...
export const ICONS_LIST = [
    <AiChatBoxIcon/>,<ModetitrationIcon/>,<LegalIcon/>,<AiIcon/>
]

export const HERO_LIST = [
  {
    number: "/assets/images/png/01.png",
    title: "AI Chatbots don’t create enterprse-grade apps",
    discription:
    ...
    slide: "/assets/images/png/hero-slide-one.png",
  },
  {
    number: "/assets/images/png/02.png",
    ...
    slide: "/assets/images/png/hero-slide-two-img.png",
  },
  {
    number: "/assets/images/png/03.png",
    ...
    slide: "/assets/images/png/hero-slide-three-img.png",
  },
  {
